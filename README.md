...
- Mission Control operator UI (release candidate `phase4_step14`; conversational installer `phase4_step15` — [docs/FIRST_IMPRESSION_CERTIFICATION.md](docs/FIRST_IMPRESSION_CERTIFICATION.md))
...
- [docs/OPENCLAW_FINAL_PARITY_AUDIT.md](docs/OPENCLAW_FINAL_PARITY_AUDIT.md) — certification totals, boundedness metrics, verification matrix
- [docs/PHASE1_CERTIFICATION_CLOSURE_PHASE2_BOUNDARY.md](docs/PHASE1_CERTIFICATION_CLOSURE_PHASE2_BOUNDARY.md) — freeze declaration, Phase 2 activation boundary
...
- [docs/OPENCLAW_FUNCTIONAL_PARITY_STATUS.md](docs/OPENCLAW_FUNCTIONAL_PARITY_STATUS.md)
