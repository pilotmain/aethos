...
def default_runtime_state(*, workspace_root: Path | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "runtime_metrics": {
            ...
            "adaptive_retry_scheduled_total": 0,
            "adaptive_retry_blocked_total": 0,
            "retry_exhausted_total": 0,
            "retry_strategy_changes_total": 0,
            "queue_pressure_events_total": 0,
...
def ensure_operator_context_schema(st: dict[str, Any]) -> dict[str, Any]:
    ...
    if not isinstance(rc, dict):
        st["repair_contexts"] = dict(base.get("repair_contexts") or {"latest_by_project": {}})
    rc.setdefault("latest_by_project", {})
...
def load_runtime_state() -> dict[str, Any]:
    ...
    try:
        ...
        runtime_continuity.ensure_runtime_continuity_schema(data)
        return data
