...
def format_idea_draft_reply(payload: dict) -> str:
    ...
    return (
        ...
        "1. Strategy Agent — validate the problem and target user\n"
        "2. Marketing Agent — define positioning and audience\n"
        "3. Dev Agent — outline MVP scope\n"
        "4. QA Agent — define acceptance checks\n"
        "5. Ops Agent — choose deployment path\n\n"
