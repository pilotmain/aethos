...
from nexa_cli.platform import (
    detect,
    detect_optional_tool,
    human_os_line,
    ollama_install_hint,
)
from nexa_cli.ui import (
    confirm,
    disk_space_line,
    get_input,
...
from nexa_cli.welcome import print_welcome_screen
...
def run_setup_wizard(*, install_kind: str | None = None) -> int:
    ...
    try:
        from nexa_cli.cli_status import try_post_install_health_hint
