...
"""Agent-task intent benchmark against local Ollama (see ``NEXA_OLLAMA_DEFAULT_MODEL``; ``qwen2.5:7b`` recommended).
...
def build_intent_classifier_system_prompt(base_instruction: str) -> str:
    """Append benchmark-aligned few-shots (same module as production ``INTENT_CLASSIFIER_SYSTEM``)."""
