...
def test_openapi_has_core_contract_paths() -> None:
    ...
    for rel in (
        ...
        "/api/v1/mission-control/runtime",
        "/api/v1/mission-control/agents",
        "/api/v1/mission-control/tasks",
        "/api/v1/mission-control/deployments",
        "/api/v1/mission-control/providers",
        "/api/v1/mission-control/runtime-health",
        "/api/v1/mission-control/runtime-events",
        "/api/v1/mission-control/runtime-metrics",
        "/api/v1/mission-control/plugins",
        "/api/v1/mission-control/runtime-panels",
        "/api/v1/plugins/",
        "/api/v1/plugins/load",
